...
variable "database_url_param" {
  description = "Database URL (e.g., file:./dev.db or RDS connection string)"
  type        = string
...
resource "aws_route_table" "private_1" {
  ...
  tags = {
    Name = "${var.project_name}-rt-private-1"
  }
}
...
resource "aws_route_table" "private_2" {
  ...
  tags = {
    Name = "${var.project_name}-rt-private-2"
  }
}
...
resource "aws_ecs_cluster_capacity_providers" "main" {
  ...
  capacity_providers = ["CAPACITY_PROVIDER_AUTOSCALING"]
...
output "application_url" {
  description = "Application URL (frontend via ALB)"
  value       = "http://${aws_lb.main.dns_name}"
}

output "api_url" {
  description = "API URL (backend via ALB)"
  value       = "http://${aws_lb.main.dns_name}:${var.backend_port}"
}
